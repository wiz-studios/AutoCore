...
do $$ begin
  if not exists (select 1 from pg_policies where schemaname = 'public' and tablename = 'seller_verification' and policyname = 'seller_verification_select_own') then
...
do $$ begin
  if not exists (select 1 from pg_policies where schemaname = 'public' and tablename = 'seller_verification' and policyname = 'seller_verification_insert_own') then
...
do $$ begin
  if not exists (select 1 from pg_policies where schemaname = 'public' and tablename = 'seller_verification' and policyname = 'seller_verification_update_admin') then
...
do $$ begin
  if not exists (select 1 from pg_policies where schemaname = 'public' and tablename = 'car_listings' and policyname = 'car_listings_select_public') then
...
do $$ begin
  if not exists (select 1 from pg_policies where schemaname = 'public' and tablename = 'car_listings' and policyname = 'car_listings_insert_seller') then
...
do $$ begin
  if not exists (select 1 from pg_policies where schemaname = 'public' and tablename = 'car_listings' and policyname = 'car_listings_update_seller') then
...
do $$ begin
  if not exists (select 1 from pg_policies where schemaname = 'public' and tablename = 'car_listings' and policyname = 'car_listings_delete_seller') then
...
do $$ begin
  if not exists (select 1 from pg_policies where schemaname = 'public' and tablename = 'car_images' and policyname = 'car_images_select_public') then
    create policy "car_images_select_public" on public.car_images for select using (true);
  end if;
end $$;

do $$ begin
  if not exists (select 1 from pg_policies where schemaname = 'public' and tablename = 'car_images' and policyname = 'car_images_insert_seller') then
...
do $$ begin
  if not exists (select 1 from pg_policies where schemaname = 'public' and tablename = 'car_images' and policyname = 'car_images_delete_seller') then
...
do $$ begin
  if not exists (select 1 from pg_policies where schemaname = 'public' and tablename = 'messages' and policyname = 'messages_update_read') then
...
do $$ begin
  if not exists (select 1 from pg_policies where schemaname = 'public' and tablename = 'saved_listings' and policyname = 'saved_listings_select_own') then
    create policy "saved_listings_select_own" on public.saved_listings for select using (auth.uid() = user_id);
  end if;
end $$;

do $$ begin
  if not exists (select 1 from pg_policies where schemaname = 'public' and tablename = 'saved_listings' and policyname = 'saved_listings_insert_own') then
    create policy "saved_listings_insert_own" on public.saved_listings for insert with check (auth.uid() = user_id);
  end if;
end $$;

do $$ begin
  if not exists (select 1 from pg_policies where schemaname = 'public' and tablename = 'saved_listings' and policyname = 'saved_listings_delete_own') then
    create policy "saved_listings_delete_own" on public.saved_listings for delete using (auth.uid() = user_id);
  end if;
end $$;

do $$ begin
  if not exists (select 1 from pg_policies where schemaname = 'public' and tablename = 'inquiries' and policyname = 'inquiries_select_own') then
...
do $$ begin
  if not exists (select 1 from pg_policies where schemaname = 'public' and tablename = 'inquiries' and policyname = 'inquiries_insert_buyer') then
...
do $$ begin
  if not exists (select 1 from pg_policies where schemaname = 'public' and tablename = 'inquiries' and policyname = 'inquiries_update_seller') then
...
do $$ begin
  if not exists (select 1 from pg_policies where schemaname = 'public' and tablename = 'payments' and policyname = 'payments_insert_buyer') then
...
do $$ begin
  if not exists (select 1 from pg_policies where schemaname = 'public' and tablename = 'payments' and policyname = 'payments_update_admin') then
...
do $$ begin
  if not exists (select 1 from pg_policies where schemaname = 'public' and tablename = 'flagged_listings' and policyname = 'flagged_listings_insert_user') then
...
do $$ begin
  if not exists (select 1 from pg_policies where schemaname = 'public' and tablename = 'flagged_listings' and policyname = 'flagged_listings_select_admin') then
...
do $$ begin
  if not exists (select 1 from pg_policies where schemaname = 'public' and tablename = 'flagged_listings' and policyname = 'flagged_listings_update_admin') then
...
do $$ begin
  if not exists (select 1 from pg_policies where schemaname = 'public' and tablename = 'activity_log' and policyname = 'activity_log_select_own') then
...
do $$ begin
  if not exists (select 1 from pg_policies where schemaname = 'public' and tablename = 'analytics' and policyname = 'analytics_select_listing_owner') then
...
create index if not exists idx_car_listings_seller_id on public.car_listings(seller_id);
...
create index if not exists idx_inquiries_buyer_seller on public.inquiries(buyer_id, seller_id);
create index if not exists idx_payments_buyer_seller on public.payments(buyer_id, seller_id);
